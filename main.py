...
DATABASE = {
  ...
  "books_class_9": [
    ...
    {"title": "Physical Science (Class 9)", "link": "https://drive.google.com/file/d/YOUR_LINK_HERE"},
    {"title": "Life Science (Class 9)", "link": "https://drive.google.com/file/d/YOUR_LINK_HERE"}
  ],
  "books_class_8": [
...
def main(page: ft.Page):
    ...
    page.padding = 0
    page.spacing = 0
    # Material 3 Theme with Cyan Seed
    ...
    def create_college_card(item):
        ...
        if seats == 0:
            ...
            status_col = "orange"
            status_text = f"FAST: {seats} LEFT"
        else:
            status_col = "green"
            status_text = f"OPEN: {seats} SEATS"
    ...
    # --- 4. VIEW LOGIC (Direct Load) ---
    
    # We create the content immediately. No functions, no delays.
    ...
    # Add to Page (Order matters)
    # Header -> Banner -> Body -> Nav
    layout = ft.Column([header, banner, body], expand=True, spacing=0)
